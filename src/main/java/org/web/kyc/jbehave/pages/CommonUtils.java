...
public class CommonUtils extends WebDriverUtils {
    ...
    private By graph_side_panel_headoffice_text_xpath =By.xpath("//tbody/tr/td/div/span");
    ...
    public void dVerifyDetailsSectionInSidePanel(String nodeTitle){
       ...
       Document entityDetailsDocument = httpRequest().getResultsFormDataBase(ENTITY_DETAILS, nvPairs);
