...
public class OwnersGraphPage extends WebDriverUtils {
    ...
    private By owners_graph_multiple_node_xpath = By.xpath(".//div[@class='graph-container']//*[contains(@class,'multiple')]");
    private By owners_graph_multiple_node_title_xpath = By.xpath(".//*[local-name()='text']/*[local-name()='title']");
    private By owners_graph_multiple_node_non_entity_xpath = By.xpath(".//*[@class='node others']");
    ...
    public void verifyingCountForMultipleDiplayedNodes(String legalEntityTitle, String countValue) {
        List<WebElement> multipleNode  = getWebElements(owners_graph_multiple_node_xpath);
    ...
    public void selectingNodeToBeClicked(String expectedEntityTile){
        ...
        for(int i=0;i<nodes.size();i++){
            String actualEntityTile = nodes.get(i).findElement(owners_graph_multiple_node_title_xpath).getText();
